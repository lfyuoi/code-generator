...
public class DynamicFileGenerator {
     ...
     */
    public  static  void doGenerate(String relativeInputPath,String outputPath,Object model) throws TemplateException, IOException {
     ...
     * @throws TemplateException
     */
    public  static  void doGeneratePath(String inputPath,String outputPath,Object model) throws TemplateException, IOException {
        // new 出 Configuration 对象，参数为 FreeMarker 版本号
        Configuration configuration = new Configuration(Configuration.VERSION_2_3_32);
